...
const NotificationsDropdown = ({ notifications = [] }: NotificationsDropdownProps) => {
  ...
  return (
    <Dropdown align='right' className='relative'>
      <DropdownTrigger>
        <div className='relative p-2 rounded-full bg-gray-200 hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-500 cursor-pointer transition-colors text-primary dark:text-white '>
